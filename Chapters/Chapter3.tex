...
La función \texttt{app\_main()}, figura \ref{fig:flujo:sistema}, crea la tarea \texttt{administrator\_callback} con alta prioridad, que actúa como un coordinador general que gestiona la interacción entre módulos y subsistemas.
