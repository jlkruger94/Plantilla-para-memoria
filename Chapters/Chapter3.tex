...
Como se ilustra en la figura \ref{fig:flujo:sistema}, la función \texttt{app\_main()} crea la tarea \texttt{administrator\_callback} con alta prioridad, que actúa como un coordinador general que gestiona la interacción entre módulos y subsistemas.
